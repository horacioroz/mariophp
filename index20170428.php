		...
		<!-- Footer -->
			<footer id="footer">
				<ul class="icons">
					...
					<li><a href="https://www.facebook.com/cintasdecorativasautoadhesivas.decorline?fref=ts" class="icon alt fa-facebook"><span class="label">Facebook</span></a></li>
				...
				<ul class="copyright">
					<li>&copy; Decorline. All rights reserved.</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
				</ul>
			</footer>
